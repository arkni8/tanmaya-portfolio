        ...
        <section className='projects' id='projects'>
            <div className="container">
                <div className="frame">
                    ...
                    <ProjectCard imgLink={process.env.NODE_ENV === 'production' ? 'images/ISP_website_Skeleton.webp' : `images/ISP_website_Skeleton.webp`} 
                    ...
                    <ProjectCard imgLink={process.env.NODE_ENV === 'production' ? 'images/Forum_webapp.webp' : `images/Forum_webapp.webp`}
                    ...
                    <ProjectCard imgLink={process.env.NODE_ENV === 'production' ? 'images/Keeper_Notes.webp' : `images/Keeper_Notes.webp`}
                    ...
                    <ProjectCard imgLink={process.env.NODE_ENV === 'production' ? 'images/Webapp_for_space_tourism.webp' : `images/Webapp_for_space_tourism.webp`}
