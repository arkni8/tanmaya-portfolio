        ...
        <section className='projects' id='projects'>
            <div className="container">
                <div className="frame">
                    ...
                    <ProjectCard imgLink='tanmaya-portfolio/images/ISP_website_Skeleton.webp' srcCode='https://lnkd.in/dZky2F_9' liveSite='https://lnkd.in/dcPhknKe'>
                    ...
                    <ProjectCard imgLink='tanmaya-portfolio/images/Forum_webapp.webp' srcCode='https://lnkd.in/d93wbGZZ' liveSite='https://lnkd.in/dpSPQPzK'>
                    ...
                    <ProjectCard imgLink='tanmaya-portfolio/images/Keeper_Notes.webp' srcCode='https://lnkd.in/dcNVftBH' liveSite='https://keeper-app-for-notes.herokuapp.com/'>
                    ...
                    <ProjectCard imgLink='tanmaya-portfolio/images/Webapp_for_space_tourism.webp' srcCode='https://lnkd.in/d6Yc9KHV' liveSite='https://lnkd.in/dzgYEQTi'>
