    ...
    return (
        <section className='about-me' id='about-me'>
            <div className="container">
                ...
                <p>If you are looking for someone like me, feel free to reach out to me. If you are looking to collab, or for hiring me or maybe you just want to have a chat,
                    to give me any feedback - I would love to hear from you!</p> <a style={{textDecoration: ' underline '}} href="#contact-me"><p>Click here to send me an email.</p></a>
                </div>
            </div>
            <div className="decor">
                {/* <BgDecorSVG /> */}
